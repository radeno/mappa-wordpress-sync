...
class WpMappaHelper
{
    ...
    public static function updatePlace(array $mappaObject, array $options) : \WP_Post
    {
        return ManagerFactory::processSingleData($mappaObject, MAPPA_GEO_PLACE, ['language' => $options['language']]);
    }

    public static function updateRoute(array $mappaObject, array $options) : \WP_Post
    {
        return ManagerFactory::processSingleData($mappaObject, MAPPA_GEO_ROUTE, ['language' => $options['language']]);
    }

    public static function updateCategory(array $mappaObject, array $options)
    {
    ...
    public static function updateCategoryGroup(array $mappaObject, array $options)
    {
    ...
    public static function updateEvent(array $mappaObject, array $options)
    {
    ...
    public static function fetchAndUpdatePlace(int $postId, array $options) : \WP_Post
    {
    ...
    public static function fetchAndUpdateRoute(int $postId, array $options) : \WP_Post
    {
        $mappaId     = \get_post_meta($postId, '_mappa_id', true);
    ...
    public static function fetchAndUpdateEvent(int $postId, array $options) : \WP_Post
    {
        $mappaId     = \get_post_meta($postId, '_mappa_id', true);
    ...
    public static function fetchAndUpdateCategory(int $termId, array $options) : \WP_Term
    {
    ...
    public static function fetchAndUpdateCategoryGroup(int $termId, array $options) : \WP_Term
    {
        $mappaId     = \get_post_meta($termId, '_mappa_id', true);
