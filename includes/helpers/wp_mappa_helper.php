...
class WpMappaHelper
{
    ...
    {
        return ManagerFactory::processSingleData(
            $mappaObject,
            MAPPA_GEO_CATEGORY,
            $options
        );
    ...
    public static function fetchAndUpdatePlace(int $postId, array $options) : GeoPlaceManager
    {
        ...
        return self::updatePlace($mappaObject, ['language' => $options['language'], 'force_update' => $options['force_update'] ?? false]);
    }
    ...
    public static function fetchAndUpdateRoute(int $postId, array $options) : GeoRouteManager
    {
        ...
        return self::updateRoute($mappaObject, ['language' => $options['language'], 'force_update' => $options['force_update'] ?? false]);
    }
    ...
    public static function fetchAndUpdateEvent(int $postId, array $options) : MessageEventManager
    {
        ...
        return self::updateEvent($mappaObject, ['language' => $options['language'], 'force_update' => $options['force_update'] ?? false]);
    }
    ...
    public static function fetchAndUpdateCategory(int $termId, array $options) : GeoCategoryManager
    {
        ...
        return self::updateCategory($mappaObject, ['language' => $options['language'], 'force_update' => $options['force_update'] ?? false]);
    }
    ...
    public static function fetchAndUpdateCategoryGroup(int $termId, array $options) : GeoCategoryGroupManager
    {
        ...
        return self::updateCategoryGroup($mappaObject, ['language' => $options['language'], 'force_update' => $options['force_update'] ?? false]);
    }
}
